...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.PushinParameter pushin_param = 140;
  inline bool has_pushin_param() const;
  inline void clear_pushin_param();
  static const int kPushinParamFieldNumber = 140;
  inline const ::caffe::PushinParameter& pushin_param() const;
  inline ::caffe::PushinParameter* mutable_pushin_param();
  inline ::caffe::PushinParameter* release_pushin_param();
  inline void set_allocated_pushin_param(::caffe::PushinParameter* pushin_param);
 ...
 private:
  ...
  inline void set_has_pushin_param();
  inline void clear_has_pushin_param();
  ...
  ::caffe::PushinParameter* pushin_param_;
  int phase_;
...
class PushinParameter : public ::google::protobuf::Message {
 public:
  PushinParameter();
  virtual ~PushinParameter();

  PushinParameter(const PushinParameter& from);

  inline PushinParameter& operator=(const PushinParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const PushinParameter& default_instance();

  void Swap(PushinParameter* other);

  // implements Message ----------------------------------------------

  PushinParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const PushinParameter& from);
  void MergeFrom(const PushinParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional float pushin_ratio = 1 [default = 0.01];
  inline bool has_pushin_ratio() const;
  inline void clear_pushin_ratio();
  static const int kPushinRatioFieldNumber = 1;
  inline float pushin_ratio() const;
  inline void set_pushin_ratio(float value);

  // @@protoc_insertion_point(class_scope:caffe.PushinParameter)
 private:
  inline void set_has_pushin_ratio();
  inline void clear_has_pushin_ratio();
  ...
  void InitAsDefaultInstance();
  static PushinParameter* default_instance_;
};
// ===================================================================
...
// optional .caffe.PushinParameter pushin_param = 140;
inline bool LayerParameter::has_pushin_param() const {
  return (_has_bits_[1] & 0x00080000u) != 0;
}
inline void LayerParameter::set_has_pushin_param() {
  _has_bits_[1] |= 0x00080000u;
}
inline void LayerParameter::clear_has_pushin_param() {
  _has_bits_[1] &= ~0x00080000u;
}
inline void LayerParameter::clear_pushin_param() {
  if (pushin_param_ != NULL) pushin_param_->::caffe::PushinParameter::Clear();
  clear_has_pushin_param();
}
inline const ::caffe::PushinParameter& LayerParameter::pushin_param() const {
  return pushin_param_ != NULL ? *pushin_param_ : *default_instance_->pushin_param_;
}
inline ::caffe::PushinParameter* LayerParameter::mutable_pushin_param() {
  set_has_pushin_param();
  if (pushin_param_ == NULL) pushin_param_ = new ::caffe::PushinParameter;
  return pushin_param_;
}
inline ::caffe::PushinParameter* LayerParameter::release_pushin_param() {
  clear_has_pushin_param();
  ::caffe::PushinParameter* temp = pushin_param_;
  pushin_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_pushin_param(::caffe::PushinParameter* pushin_param) {
  delete pushin_param_;
  pushin_param_ = pushin_param;
  if (pushin_param) {
    set_has_pushin_param();
  } else {
    clear_has_pushin_param();
...
// optional float pushin_ratio = 1 [default = 0.01];
inline bool PushinParameter::has_pushin_ratio() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PushinParameter::set_has_pushin_ratio() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PushinParameter::clear_has_pushin_ratio() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PushinParameter::clear_pushin_ratio() {
  pushin_ratio_ = 0.01f;
  clear_has_pushin_ratio();
}
inline float PushinParameter::pushin_ratio() const {
  return pushin_ratio_;
}
inline void PushinParameter::set_pushin_ratio(float value) {
  set_has_pushin_ratio();
  pushin_ratio_ = value;
}
